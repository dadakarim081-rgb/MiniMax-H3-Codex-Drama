...
# Official H3 Prompt Writing

This is a Codex-valid entrypoint for MiniMax's portable official skill. Read [the vendored official skill](references/official/SKILL.md) completely, then read the guide selected below. The upstream file is preserved unchanged; this wrapper removes only frontmatter that Codex does not accept.

## Select the official guide

1. Identify the input mode: T2VA, I2VA, FL2VA, L2VA, or full-reference Ref2VA.
2. For base text/keyframe modes, read [the official base guide](references/official/references/base-en.txt) and follow its final prompt structure.
3. For full-reference mode, read [the official reference guide](references/official/references/ref-en.txt) and follow its six-section rewrite format.
...
Read the official reference guide for label rules, retention analysis, and complete examples.
